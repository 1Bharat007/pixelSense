...
use windows::Win32::Devices::Sensors::{
    ISensorManager, SensorManager, SENSOR_DATA_TYPE_LIGHT_LEVEL_LUX, SENSOR_STATE_READY,
...
impl SensorSession {
    pub fn new() -> Self {
        unsafe {
            ...
            let manager: Result<ISensorManager, _> =
                CoCreateInstance(&SensorManager, None, CLSCTX_INPROC_SERVER);
            Self {
                manager: manager.ok(),
            }
        }
    ...
    pub fn read_lux(&self) -> Result<f32, PlatformError> {
                                        ...
                                        if let Ok(data) = sensor.GetData() {
                                                ...
                                                .GetSensorValue(&SENSOR_DATA_TYPE_LIGHT_LEVEL_LUX)
                                            {
                                                ...
                                                if vt == VT_R4.0 as u16 {
                                                    ...
                                                    == windows::Win32::System::Variant::VT_UI4.0
                                                        as u16
                                                {
        ...
        Err(PlatformError::NativeApiUnavailable(
            "Ambient Light Sensor not found or not ready".into(),
        ))
    }
}
